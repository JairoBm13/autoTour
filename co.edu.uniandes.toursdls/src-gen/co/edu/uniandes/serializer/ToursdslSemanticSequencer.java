...
public class ToursdslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=STRING destino=[Panorama|ID] origen=[Panorama|ID] posicion=Coordenada rotacion=Coordenada)
	 */
	protected void sequence_Hotspot(ISerializationContext context, Hotspot semanticObject) {
		...
		feeder.accept(grammarAccess.getHotspotAccess().getNameSTRINGTerminalRuleCall_3_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getHotspotAccess().getDestinoPanoramaIDTerminalRuleCall_7_0_1(), semanticObject.getDestino());
		feeder.accept(grammarAccess.getHotspotAccess().getOrigenPanoramaIDTerminalRuleCall_11_0_1(), semanticObject.getOrigen());
		feeder.accept(grammarAccess.getHotspotAccess().getPosicionCoordenadaParserRuleCall_15_0(), semanticObject.getPosicion());
		feeder.accept(grammarAccess.getHotspotAccess().getRotacionCoordenadaParserRuleCall_19_0(), semanticObject.getRotacion());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=STRING description=STRING places+=Hotspot places+=Hotspot*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=STRING places+=Panorama places+=Panorama*)
	 */
