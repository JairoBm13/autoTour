 ...
 * </p>
 * <ul>
 *   <li>{@link co.edu.uniandes.tours.tours.Rotation#getPosx <em>Posx</em>}</li>
 *   <li>{@link co.edu.uniandes.tours.tours.Rotation#getPosy <em>Posy</em>}</li>
 *   <li>{@link co.edu.uniandes.tours.tours.Rotation#getPosz <em>Posz</em>}</li>
 * </ul>
 *
 * @see co.edu.uniandes.tours.tours.ToursPackage#getRotation()
 * @model
 * @generated
 */
public interface Rotation extends EObject
{
   ...
   * @see #setPosx(double)
   * @see co.edu.uniandes.tours.tours.ToursPackage#getRotation_Posx()
   * @model
   * @generated
   */
  double getPosx();
  ...
  /**
   * Sets the value of the '{@link co.edu.uniandes.tours.tours.Rotation#getPosx <em>Posx</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setPosy(double)
   * @see co.edu.uniandes.tours.tours.ToursPackage#getRotation_Posy()
   * @model
   * @generated
   */
  double getPosy();
  ...
  /**
   * Sets the value of the '{@link co.edu.uniandes.tours.tours.Rotation#getPosy <em>Posy</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setPosz(double)
   * @see co.edu.uniandes.tours.tours.ToursPackage#getRotation_Posz()
   * @model
   * @generated
   */
  double getPosz();
  ...
  /**
   * Sets the value of the '{@link co.edu.uniandes.tours.tours.Rotation#getPosz <em>Posz</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
